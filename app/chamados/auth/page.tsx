      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ color: 'var(--color-textSecondary)' }}>
              Login Universal - Admin, Empresa ou Colaborador
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ 
              ...
              <p style={{ marginBottom: 'var(--gap-sm)' }}>
                🔐 Login automático baseado em permissões:
              </p>
              <p style={{ marginBottom: 'var(--gap-sm)' }}>
                👑 <strong>Admin/AdminMaster:</strong> → Painel Administrativo
              </p>
              <p style={{ marginBottom: 'var(--gap-md)' }}>
                👤 <strong>Colaborador:</strong> → Sistema de Chamados
              </p>
