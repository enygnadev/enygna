...
export default function EmpresaLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const collections = ['empresas', 'chamados_empresas', 'frota_empresas', 'financeiro_empresas', 'documentos_empresas'];
      ...
      for (const collectionName of collections) {
        ...
        if (!snapshot.empty) {
          ...
          if (sistemaEncontrado === 'empresas') sistemaEncontrado = 'ponto';
          break;
        }
      }
      ...
      if (empresaEncontrada) {
        ...
        switch (sistemaEncontrado) {
          ...
          case 'documentos':
            ...
            break;
          case 'ponto':
            router.push(`/empresa/dashboard?empresaId=${empresaEncontrada.id}`);
            break;
          default:
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ opacity: 0.8, marginTop: '0.5rem' }}>
            Acesse seus sistemas empresariais
          </p>
        </div>
